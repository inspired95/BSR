...
public class DefaultConfigurationCreator
{
    ...
    public static void createDefaultCategoriesConfiguration()
    {
        ...
        try (InputStream defaultConfigurationStream = DefaultConfigurationCreator.class.getResourceAsStream( "/" + CATEGORIES_CONFIGURATION_FILE_NAME ))
        {
            createDirectoryIfNeeded();

            File categoriesConfigurationFile = new File( CONFIGURATION_PATH, CATEGORIES_CONFIGURATION_FILE_NAME );
