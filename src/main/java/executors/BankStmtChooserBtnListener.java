...
public class BankStmtChooserBtnListener implements ActionListener {
    private final static Logger LOGGER = Logger.getLogger(BankStmtChooserBtnListener.class.getName());
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (status == JFileChooser.APPROVE_OPTION)
        {
            ...
            {
                BankStmtConverter bankStmtConverter = new BankStmtConverterFactory().match(chosenBank);
