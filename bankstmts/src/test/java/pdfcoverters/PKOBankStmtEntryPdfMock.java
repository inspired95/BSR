...
public class PKOBankStmtEntryPdfMock
{
    ...
    private PKOBankStmtEntryPdfMock(
        String date, String ID, String typeDescription, String amount, String descLine1,
        String descLine2 )
    {
    ...
    public static class Builder
    {
        ...
        {
            return new PKOBankStmtEntryPdfMock(
                date, ID, typeDescription, amount, descLine1, descLine2 );
        }
    }
}
