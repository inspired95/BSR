...
import static utils.Constants.PKO_BANK_STMT_BALANCE_SUMMARY_TXT;
import static utils.Constants.PKO_BANK_STMT_PAGE_BALANCE_SUMMARY_TXT;
...
public class PKOBankStmtPdfMock {
    ...
    public PKOBankStmtPdfMock addEntry( PKOBankStmtEntryPdfMock entry ){
        ...
        if (!entry.getThirdLine().isEmpty()) content.add(entry.getThirdLine());
        return this;
    }
