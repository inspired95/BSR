...
public class OperationsTableComparatorFactory
{
    ...
    {
        if( operationsSortingBy.equals( Constants.DATE ) )
            return new Operation.OperationDateComparator();
        else if( operationsSortingBy.equals( Constants.AMOUNT ) )
            return new Operation.OperationAmountComparator();
        else if( operationsSortingBy.equals( Constants.TYPE ) )
            return new Operation.OperationTypeComparator();
        else if( operationsSortingBy.equals( Constants.CATEGORY ) )
